        ...
        <div className="form-wrap">
          <FormProvider {...methods}>
            <form className="form" onSubmit={methods.handleSubmit(onSubmit)}>
              ...
              {tab === 1 && (
                <>
                  <RHFTextfield className="input" name="name" placeholder="Enter Full Name" label="Enter Full Name" />
                  <RHFTextfield className="input email-input" name="company" placeholder="Ex; Boring Marketing .Co Ltd" label="Enter Company Name" />
